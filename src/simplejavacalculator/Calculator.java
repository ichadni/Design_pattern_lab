...
public class Calculator implements Calc{//its implement the interface of Calc
    ...
    public enum triOperatorModes {//add new feature
        //square, squareRoot, oneDividedBy, cos, sin, tan, log, rate, abs, ln,if needed we can add another new functionality
    }

    private Double num1, num2;
    private BiOperatorModes mode = BiOperatorModes.normal;

    public double calculateBiImpl() {//change in this line
    ...
    public double calculateBi(BiOperatorModes newMode, Double num) {//changed in this line
        if (mode.equals(BiOperatorModes.normal)) {
            num2 = 0.0;
            num1 = num;
            mode = newMode;
